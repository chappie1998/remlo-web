        ...
        <div className="text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-base">
              Sign in using your social account to continue
            </p>
          </div>
          ...
          <Button 
            ...
            className="w-full bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/50 text-white py-3 px-4 rounded-lg flex items-center justify-center gap-3 text-base font-medium transition-colors"
          >
